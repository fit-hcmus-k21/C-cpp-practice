...
void ZoomOutBmp(BITMAP img1, BITMAP &img2, int s)
{
    ...
    *                                                                                   ***/
    ...
    int nRowM = 0;
    if ((img1.dib.width*img1.dib.bpp/8) % (s) == 0)
    {
        nRowM = (img1.dib.width*img1.dib.bpp/8)/(s);
    }
    else
    {
        nRowM = (img1.dib.width*img1.dib.bpp/8)/(s) + 1;
    }
    ...
    for (int i=0;i<nColM;i++)     
    {
        ...
        for (int j=0;j<nRowM;j++)
        {
            ...
            if ((M-SttRow)>=s && (N-(SttCol))>=s)
            {
                ...
                img2.PixelData[index++] = (char) Sum/(s*s);
                Sum = 0;
                SttRow = SttRow + s;
            ...
            else
            {
                if ((M-SttRow)<s && (N-(SttCol)<s))
                {
                    ...
                    img2.PixelData[index++] = (char) Sum/(x*y);
                    Sum = 0;
                    SttRow = SttRow + s;
                }
                else
                {
                    if (M-SttRow<s)
                    {
                        ...
                        img2.PixelData[index++] = (char) Sum/(s*c);
                        Sum = 0;
                        SttRow = SttRow + s;
                    }
                    else
                    {
                        if (N-SttCol<s)
                        {
                            ...
                            img2.PixelData[index++] = (char) Sum/(r*s);
                            Sum = 0;
                            SttRow = SttRow + s;
                        }
                    }
